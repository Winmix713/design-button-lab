...
export const ComponentSelector: React.FC<ComponentSelectorProps> = ({ onSelectComponent }) => {
  const { recentlyUsedComponents } = useComponentWizard();
            ...
            {recentlyUsedComponents.map((componentType) => {
              ...
              return (
                <Button
                  ...
                  onPress={() => onSelectComponent(componentType)}
                >
                  {component.name}
                </Button>
              );
