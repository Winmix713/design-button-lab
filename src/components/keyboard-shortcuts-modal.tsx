...
export const KeyboardShortcutsModal: React.FC<KeyboardShortcutsModalProps> = ({
  ...
  const shortcuts = [
    ...
    { keys: ["Ctrl", "E"], description: "Export component settings" },
    { keys: ["Ctrl", "I"], description: "Import component settings" },
    ...
    { keys: ["Ctrl", "Space"], description: "Return to component selector" }
  ];
